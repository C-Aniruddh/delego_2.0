...
import io.aniruddh.delego.fragments.IntroActivity;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private static String login_endpoint = Keys.SERVER + "login";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean logged = prefs.getBoolean("logged_status", false);
        if(logged){
    ...
    private Boolean performLogin(String username, String password) throws BridgeException{
        Form form = new Form()
        ...
        if(login_status){
            ...
            String user_background = ason.getString("login_background");
            String auth_token = ason.getString("auth_token");
            String user_committee = ason.getString("login_committee");
            String user_id = ason.getString("login_identifier");
            String user_email = ason.getString("email");
            String user_type = ason.getString("type");
            String user_full_name = ason.getString("fullname");

            editor.putString("background", user_background);
            editor.putString("auth_token", auth_token);
            editor.putString("committee", user_committee);
            editor.putString("identifier", user_id);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                login_success = performLogin(mEmail, mPassword);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPasswordView.setError("The Password or Email ID is incorrect");
