...
public class AllDelegatesFragment extends Fragment {
    ...
    public AllDelegatesFragment() {
        // Required empty public constructor
    }

    public static AllDelegatesFragment newInstance(String param1, String param2) {
        AllDelegatesFragment fragment = new AllDelegatesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String text = "Showing all delegates : ";
    ...
    private void fetchStoreItems() {
        final String URL = Keys.SERVER + "allusers";
